...
from .aggregate import aggregate_scores, write_summary_csv
...
def score_command(args: argparse.Namespace) -> int:
    ...
    if not (args.output or args.summary_json or args.summary_csv):
...
def build_parser() -> argparse.ArgumentParser:
    ...
    score_parser.add_argument("--summary-json", help="write aggregate summary as JSON")
    score_parser.add_argument("--summary-csv", help="write aggregate summary as CSV")
